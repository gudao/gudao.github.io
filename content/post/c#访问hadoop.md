...
    我使用的是hadoop-1.0.3，当前最新版本是2.0的阿尔法版，hadoopfs.thrift文件可以在\src\contrib\thriftfs\if\hadoopfs.thrift找到，然后使用thrift-0.8.0.exe（请到[Thrift官方](http://thrift.apache.org/download/)下载最新版本）运行

<code>thrift --gen csharp hadoopfs.thrift<br/>
</code> 

命令即可生成最新的c#访问Hadoop客户端代码，如果你不愿意自己生成请在这里下载[/Content/attached/file/20120610/nix5lwmw_ayb.rar](/Content/attached/file/20120610/nix5lwmw_ayb.rar)。
